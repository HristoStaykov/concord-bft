...
class ReplicaSubsetOneWayTwoSetsIsolatingAdversary(NetworkPartitioningAdversary):
    """
    Adversary that isolates all messages except client requests
    ...
    replicas in the network, but anything addressed to them by the blocked senders
    set of replicas will be dropped.
    """
    ...
    def __init__(self, bft_network, blocked_receivers, blocked_senders):
        ...
        super(ReplicaSubsetOneWayTwoSetsIsolatingAdversary, self).__init__(bft_network)
